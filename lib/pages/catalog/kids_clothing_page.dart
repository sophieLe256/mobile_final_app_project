...
class KidClothingPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        stream: _firestore
            .collection('products')
            .where('category', isEqualTo: 'Kid')
            .where('type', isEqualTo: 'Clothing')
            .snapshots(),
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return Center(child: Text('No Clothes found in this category.'));
          }
        },
      ),
    );
